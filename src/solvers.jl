...
function U_ModeSolver(U_a::Vector,U_a_old::Matrix,U::PGDFunction,U_bc::PGDBC,U_edof::Matrix{Int},
...
#############################################
function UD_ModeSolver(U_a::Vector,U_a_old::Matrix,U::PGDFunction,U_bc::PGDBC,U_edof::Matrix{Int},
                       D_a::Vector,D_a_old::Matrix,D::PGDFunction,D_bc::PGDBC,D_edof::Matrix{Int},
                       D_mat::Matrix,b::Vector,modeItr::Int)
...
function DU_ModeSolver(D_a::Vector,D_a_old::Matrix,D::PGDFunction,D_bc::PGDBC,D_edof::Matrix{Int},
                       U_a::Vector,U_a_old::Matrix,U::PGDFunction,U_bc::PGDBC,U_edof::Matrix{Int},
                       b::Vector,modeItr::Int)
    ...
    while true; i += 1
        ...
        # JAG HAR KOMMIT HIT #
        ######################
        g = calc_globres_DU(trial_solution,D_a,U,D_mat,U_edof,b,free_dofs(U_bc))
        ...
        if maxofg < TOL # converged
            ...
            U_atemp = copy(U_a)
            U_atemp[:,modeItr+1] = trial_solution
            tot_norms = norm_of_mode(U,U_atemp[:,1:U.modes+1])
            this_norms = norm_of_mode(U,trial_solution)
            ratios = (this_norms[1]/tot_norms[1], this_norms[2]/tot_norms[2])
